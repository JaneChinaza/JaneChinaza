        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 mb-3">
             <div class="property-item">
              <div class="box">
                    <img src="/<?php  echo $agent['image'];  ?>" alt="...Property image" class="img-fluid" style="width: 360px; height:350px;" />
              </div>
              <div class="property-content">
                      <span class="city d-block mb-3">Agent <?php  echo $agent['name'] ?></span>
                      <span class="d-block mb-3"><?php  echo $agent['email']; ?></span>
                      <a
                        href="/agent_property?agent=<?php echo $agent['id'] ?>"
