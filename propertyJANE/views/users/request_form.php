                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="row" style="margin-left: 12%;">
                                                ...
                                                <div class=" col-10 mb-1">
                                                    <textarea type="text" name="reason" value="<?php echo $request['reason'] ?>" class="form-control"></textarea>
                                                </div>
                                                <label class="form-label">Describe yourself in less than 100 words</label>
                                                <div class=" col-10 mb-1">
                                                    <textarea type="text" name="description" value="<?php echo $request['description'] ?>" class="form-control"></textarea>
                                                </div>
