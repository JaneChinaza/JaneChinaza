      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">Select property</h1>
            <nav
            ...
            >
              ...
              <li class="breadcrumb-item h6 text-white"><em>Click <a href="/properties/create" class="text-warning">Here</a> to Add New Property</em></li>
              </ol>
            </nav>
            ...
            <div class="box">
              ...
              <div class="property-content">
                ...
                <div>
                  ...
                  <a href="/properties/update?id=<?php echo $property['id'] ?>"
                       class="btn btn-primary py-2 px-3">Edit</a>
                       <form style="display: inline-block;" method="POST" action="/properties/delete" >
                        <input type="hidden" name="id" value="<?php echo $property['id'] ?>"/>
                      <button type="submit" class="btn btn-sm btn btn-danger py-2 px-3">Delete</button> 
                      </form>
