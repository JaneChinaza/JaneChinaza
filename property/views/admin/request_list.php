    ...
    <div class="section section-properties">
      ...
      <section id="accepted">
        <table class="table caption-top table-sm table-striped">
            ...
            <tbody>
            <?php foreach ($allAgentRequest as $i => $agent):  ?>
              <?php if ($agent['status']==2): ?>
                <tr>
                    <th scope="row"><?php echo $i+1 ?></th>
                    <td>
                    <?php if ($agent['user_image']): ?>
                        <img src= "/<?php echo $agent['user_image']; ?>" style="width:60px;" alt="image">
                    <?php endif; ?>
                    </td>
                    <td><?php echo $agent['user_name'] ?></td>
                    <td><?php  echo $agent['reason']  ?></td>
                    <td><?php  echo $agent['agent_description']  ?></td>
                    <td>
                    <a href="/request_decline?id=<?php echo $agent['user_id'] ?>" type="button" class="btn btn-sm btn-danger py-2 px-2" style="font-size: 0.9em;"> Decline</a>
                </td>
                </tr>
              <?php endif; ?>
           <?php endforeach; ?>
            ...
            <?php foreach ($allAgentRequest as $i => $agent):  ?>
              <?php if ($agent['status']==3): ?>
                <tr>
                    ...
                    <td><?php  echo $agent['agent_description']  ?></td>
                    <td>
                      <a href="/request_accept?id=<?php echo $agent['user_id'] ?>" type="button" class="btn btn-sm btn-primary py-2 px-2" style="font-size: 0.9em; font-weight:400;">Accept</a>
                    </td>
                </tr>
              <?php endif; ?>
            <?php endforeach; ?>
            ...
            <?php foreach ($allAgentRequest as $i => $agent):  ?>
              <?php if ($agent['status']==1): ?>
                <tr>
                    ...
                    <td>
                    <div class="btn-group">
                      <a href="/request_accept?id=<?php echo $agent['user_id'] ?>" type="button" class="btn btn-sm btn-primary py-2 px-2" style="font-size: 0.9em;">Accept</a>
                      <a href="/request_decline?id=<?php echo $agent['user_id'] ?>" type="button" class="btn btn-sm btn-danger py-2 px-2" style="font-size: 0.9em;"> Decline</a>
                    </div>
                  </td>
                </tr>
